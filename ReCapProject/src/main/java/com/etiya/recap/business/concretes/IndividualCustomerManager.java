...
public class IndividualCustomerManager implements IndividualCustomerService {
	...
	public DataResult<List<IndividualCustomerDto>> getAll() {
		...
		return new SuccessDataResult<>(individualCustomerDtos, IndividualCustomerMessages.GetAll);
	}
	...
	public DataResult<IndividualCustomerDto> getById(int id) {
		...
		return new SuccessDataResult<>(individualCustomerDto, IndividualCustomerMessages.GetById);
	}
